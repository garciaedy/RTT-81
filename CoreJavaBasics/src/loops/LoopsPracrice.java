...
public class LoopsPracrice {
	...
	public static void main(String[] args) {
		...
		/*
		 Prompt:
		 Write a for loop that counts from 0 to 5, printing each number to the console.
		 */

		/*
		 Prompt:
		 Write a for loop that counts down from 5 to 0, printing each number to the console.
		 */

		/*
		 Prompt: Write a for loop that counts from 0 to 10 in increments of 2, printing each number to the console.
		 */
		...
		/* Prompt: Write a for loop that prints out each item in the below array.
		 */
			// int letters = ['a', 'b', 'c', 'd', 'e', 'f', 'g'];

		/*
		 * Prompt:  Write a for loop that sums the values in the below array.
		 */
			// int numbers = [23, 19, 23, 52, 12];
		...
		/* Prompt: Use a while loop to count from 0 to 10. */
		
		

		/* Prompt:  Use the prompt function to write a while loop that will continue to ask the
